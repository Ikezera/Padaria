const criar = () => {
  ...
  const texth1 = document.createTextNode(
    "A Padaria do Ike é um estabelecimento aconchegante e tradicional que se destaca por oferecer uma variedade de pães frescos, bolos, doces e outros produtos de panificação. Localizada em uma região de atmosfera acolhedora, a padaria é conhecida por seu atendimento amigável e produtos de alta qualidade."
  );
  pao1.src =
